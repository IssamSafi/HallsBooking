...
namespace Firstproject.Controllers
{
    public class LoginsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LoginId,UserName,Password,RoleId,UserId")] Login login)
        {
            ...
            ViewData["RoleId"] = new SelectList(_context.Role1s, "RoleId", "RoleId", login.RoleId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("LoginId,UserName,Password,RoleId,UserId")] Login login)
        {
            if (id != login.LoginId)
            {
                return NotFound();

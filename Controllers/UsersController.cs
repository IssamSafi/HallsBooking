...
namespace Firstproject.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserId,Fname,Lname,Phone,Email,ImageFile,Address")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("UserId,Fname,Lname,Phone,Email,Imagepath,ImageFile,Address")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
